...
class DataController:
    ...
    def get_data_loader(self, X, y, batch_size, trasnformations=None, partition_type:str = "train"):
        ...
        if partition_type == "train":
            return DataLoader(data, batch_size=batch_size, shuffle=True, pin_memory=True, num_workers=7)
        
        return DataLoader(data, batch_size=batch_size, pin_memory=True, num_workers=7)
